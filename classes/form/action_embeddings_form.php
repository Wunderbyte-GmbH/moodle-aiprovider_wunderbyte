...
/**
 * Embeddings action settings form.
 *
 * @package    aiprovider_wunderbyte
 * @copyright  2026 Wunderbyte GmbH
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class action_embeddings_form extends action_settings_form {
    #[\Override]
    protected function definition(): void {
        ...
        $mform->setDefault('endpoint', $actionconfig['endpoint'] ?? 'https://llm.wunderbyte.at/v1/embeddings');
        ...
        $mform->setDefault('model', $actionconfig['model'] ?? 'text-embedding-3-small');

        $mform->addElement('text', 'dimensions', get_string('dimensions', 'aiprovider_wunderbyte'), ['size' => 10]);
        $mform->setType('dimensions', PARAM_INT);
        $mform->setDefault('dimensions', $actionconfig['dimensions'] ?? 1536);
