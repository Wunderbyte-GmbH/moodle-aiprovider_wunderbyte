...
/**
 * Generate final agent reply action.
 *
 * @package    aiprovider_wunderbyte
 * @copyright  2026 Wunderbyte GmbH
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class generate_agent_reply extends base {
    /** @var int Moodle user id owning the request. */
    protected int $userid;

    /** @var string User-facing reply prompt payload. */
     ...
     * @param string $prompttext Prompt text for reply generation.
     */
    ...
    public static function get_name(): string {
        return get_string('action_generate_agent_reply', 'aiprovider_wunderbyte');
    }
    ...
    public static function get_description(): string {
        return get_string('action_generate_agent_reply_desc', 'aiprovider_wunderbyte');
    }
    ...
    public static function get_system_instruction(): string {
        return get_string('action_generate_agent_reply_instruction', 'aiprovider_wunderbyte');
    }
    ...
    public static function get_response_classname(): string {
        return \aiprovider_wunderbyte\aiactions\responses\response_generate_agent_reply::class;
    }
